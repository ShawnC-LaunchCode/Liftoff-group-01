...
<div className="card-title">
              ...
              placeholder='Search Weather / Category ' width="60" class="form-control"></input></div>
  ...
  {records && records.filter((item) => {
                return search.toLowerCase() === ''
                  ? item
                  : (item.weatherTag.toLowerCase().includes(search) || (item.clothCategory.name.toLowerCase().includes(search)));
              }).map(item => (
